...
public class JobPostingsController {
	...
	// Post a job
	@PostMapping("")
	public String postJob(@Valid @RequestBody JobpostRequest jobPosting) {
		RestTemplate restTemplate = new RestTemplate();
	...
	public String editJob(@RequestBody JobpostRequest jobPost, @PathVariable Integer id) {
		RestTemplate restTemplate = new RestTemplate();
		...
		ResponseEntity<String> response = restTemplate.exchange(
				...
				new ParameterizedTypeReference<String>(){}); // object type POJO
